# Embedded file name: KravenHD.py
...
config.plugins.KravenHD.customProfile = ConfigSelection(default='1', choices=[('1', _('1')),
 ('2', _('2')),
 ('3', _('3')),
 ('4', _('4')),
 ('5', _('5'))])
...
config.plugins.KravenHD.refreshInterval = ConfigSelection(default='15', choices=[('0', _('0')),
 ('15', _('15')),
 ('30', _('30')),
 ('60', _('60')),
 ('120', _('120')),
 ('240', _('240')),
 ('480', _('480'))])
config.plugins.KravenHD.Image = ConfigSelection(default='main-custom-PKTeam', choices=[('main-custom-atemio4you', _('Atemio4You')),
 ('main-custom-openatv', _('openATV')),
 ('main-custom-openhdf', _('openHDF')),
 ('main-custom-openmips', _('openMIPS')),
 ('main-custom-opennfr', _('openNFR')),
 ('main-custom-PKTeam', _('PKTeam'))])
config.plugins.KravenHD.Volume = ConfigSelection(default='volume-top', choices=[('volume-original', _('original')),
...
config.plugins.KravenHD.BackgroundColor = ConfigSelection(default='000000', choices=[('F0A30A', _('amber')),
 ('B27708', _('amber dark')),
 ...
 ('ffffff', _('white')),
 ('self', _('self'))])
config.plugins.KravenHD.InfobarColor = ConfigSelection(default='self', choices=[('F0A30A', _('amber')),
 ('B27708', _('amber dark')),
 ('665700', _('amber very dark')),
 ('1B1775', _('blue')),
 ('0E0C3F', _('blue dark')),
...
config.plugins.KravenHD.Progress = ConfigSelection(default='progress', choices=[('00F0A30A', _('amber')),
...
config.plugins.KravenHD.IBStyle = ConfigSelection(default='gradient', choices=[('gradient', _('gradient')), ('box', _('box'))])
...
config.plugins.KravenHD.AnalogStyle = ConfigSelection(default='00999999', choices=[('00F0A30A', _('amber')),
 ('001B1775', _('blue')),
 ('007D5929', _('brown')),
 ('000050EF', _('cobalt')),
 ('001BA1E2', _('cyan')),
 ...
 ('006C0AAB', _('violet')),
 ('00ffffff', _('white'))])
config.plugins.KravenHD.InfobarStyle = ConfigSelection(default='infobar-style-x3', choices=[('infobar-style-nopicon', _('no Picon')),
...
config.plugins.KravenHD.InfobarChannelName = ConfigSelection(default='none', choices=[('none', _('off')),
...
config.plugins.KravenHD.InfobarChannelName2 = ConfigSelection(default='none', choices=[('none', _('off')), ('infobar-channelname-small', _('Name')), ('infobar-channelname-number-small', _('Name & Number'))])
config.plugins.KravenHD.ChannelSelectionStyle = ConfigSelection(default='channelselection-style-minitv', choices=[('channelselection-style-nopicon', _('no Picon')),
 ...
 ('channelselection-style-zaqwa', _('Zaqwa')),
 ('channelselection-style-zaqwa2', _('Zaqwa 2')),
...
config.plugins.KravenHD.ChannelSelectionStyle2 = ConfigSelection(default='channelselection-style-minitv', choices=[('channelselection-style-nopicon', _('no Picon')),
 ('channelselection-style-xpicon', _('X-Picons')),
 ('channelselection-style-zpicon', _('Z-Picons')),
 ('channelselection-style-zzpicon', _('ZZ-Picons')),
 ('channelselection-style-zzzpicon', _('ZZZ-Picons')),
...
config.plugins.KravenHD.ChannelSelectionServiceSize = ConfigSelection(default='size-20', choices=[('size-16', _('16')),
 ('size-18', _('18')),
 ('size-19', _('19')),
 ('size-20', _('20')),
 ('size-22', _('22')),
 ...
 ('size-28', _('28')),
 ('size-30', _('30'))])
config.plugins.KravenHD.ChannelSelectionInfoSize = ConfigSelection(default='size-20', choices=[('size-16', _('16')),
 ('size-18', _('18')),
 ('size-19', _('19')),
 ('size-20', _('20')),
 ('size-22', _('22')),
 ...
 ('size-28', _('28')),
 ('size-30', _('30'))])
config.plugins.KravenHD.ChannelSelectionServiceSize1 = ConfigSelection(default='size-20', choices=[('size-16', _('16')),
 ('size-18', _('18')),
 ('size-19', _('19')),
 ('size-20', _('20')),
 ('size-22', _('22')),
 ('size-24', _('24')),
 ('size-26', _('26'))])
config.plugins.KravenHD.ChannelSelectionInfoSize1 = ConfigSelection(default='size-20', choices=[('size-16', _('16')),
 ('size-18', _('18')),
 ('size-19', _('19')),
 ('size-20', _('20')),
 ('size-22', _('22')),
 ('size-24', _('24')),
 ('size-26', _('26'))])
config.plugins.KravenHD.ChannelSelectionEPGSize1 = ConfigSelection(default='size-22', choices=[('size-16', _('16')),('size-17', _('17')),('size-18', _('18')),('size-19', _('19')), ('size-20', _('20')), ('size-22', _('22')), ('size-24', _('24'))])
config.plugins.KravenHD.ChannelSelectionEPGSize2 = ConfigSelection(default='size-19', choices=[('size-16', _('16')),('size-17', _('17')),('size-18', _('18')),('size-19', _('19')), ('size-20', _('20')), ('size-22', _('22')), ('size-24', _('24'))])
config.plugins.KravenHD.ChannelSelectionEPGSize3 = ConfigSelection(default='size-22', choices=[('size-16', _('16')),('size-17', _('17')),('size-18', _('18')),('size-19', _('19')), ('size-20', _('20')), ('size-22', _('22')), ('size-24', _('24'))])
config.plugins.KravenHD.ChannelSelectionServiceNA = ConfigSelection(default='00FFEA04', choices=ColorList)
config.plugins.KravenHD.NumberZapExt = ConfigSelection(default='none', choices=[('none', _('off')),
...
config.plugins.KravenHD.CoolTVGuide = ConfigSelection(default='cooltv-minitv', choices=[('cooltv-minitv', _('MiniTV')), ('cooltv-picon', _('Picon'))])
config.plugins.KravenHD.MovieSelection = ConfigSelection(default='movieselection-no-cover', choices=[('movieselection-no-cover', _('no Cover')),
...
config.plugins.KravenHD.EMCStyle = ConfigSelection(default='emc-minitv', choices=[('emc-nocover', _('no Cover')),
...
config.plugins.KravenHD.RunningText = ConfigSelection(default='startdelay=4000', choices=[('none', _('off')),
...
config.plugins.KravenHD.RunningTextSpeed = ConfigSelection(default='steptime=100', choices=[('steptime=200', _('5 px/sec')),
 ('steptime=100', _('10 px/sec')),
 ('steptime=66', _('15 px/sec')),
 ('steptime=50', _('20 px/sec'))])
config.plugins.KravenHD.ScrollBar = ConfigSelection(default='showOnDemand', choices=[('showOnDemand', _('on')), ('showNever', _('off'))])
config.plugins.KravenHD.IconStyle = ConfigSelection(default='icons-light', choices=[('icons-light', _('light')), ('icons-dark', _('dark'))])
config.plugins.KravenHD.IconStyle2 = ConfigSelection(default='icons-light2', choices=[('icons-light2', _('light')), ('icons-dark2', _('dark'))])
config.plugins.KravenHD.ClockStyle = ConfigSelection(default='clock-classic', choices=[('clock-classic', _('standard')),
...
config.plugins.KravenHD.ClockIconSize = ConfigSelection(default='size-96', choices=[('size-96', _('96')), ('size-128', _('128'))])
config.plugins.KravenHD.WeatherStyle = ConfigSelection(default='none', choices=[('none', _('off')), ('weather-big', _('big')), ('weather-small', _('small'))])
config.plugins.KravenHD.WeatherStyle2 = ConfigSelection(default='none', choices=[('none', _('off')), ('weather-left', _('on'))])
config.plugins.KravenHD.ECMVisible = ConfigSelection(default='none', choices=[('none', _('off')),
 ('ib', _('Infobar')),
 ('sib', _('SecondInfobar')),
 ('ib+sib', _('Infobar & SecondInfobar'))])
config.plugins.KravenHD.ECMLine1 = ConfigSelection(default='ShortReader', choices=[('none', _('off')),
 ('VeryShortCaid', _('short with CAID')),
 ('VeryShortReader', _('short with source')),
 ('ShortReader', _('compact'))])
config.plugins.KravenHD.ECMLine2 = ConfigSelection(default='ShortReader', choices=[('none', _('off')),
 ('VeryShortCaid', _('short with CAID')),
 ('VeryShortReader', _('short with source')),
 ('ShortReader', _('compact')),
 ('Normal', _('balanced')),
 ('Long', _('extensive')),
 ('VeryLong', _('complete'))])
config.plugins.KravenHD.ECMLine3 = ConfigSelection(default='ShortReader', choices=[('none', _('off')),
 ('VeryShortCaid', _('short with CAID')),
 ('VeryShortReader', _('short with source')),
 ('ShortReader', _('compact')),
 ('Normal', _('balanced')),
 ('Long', _('extensive'))])
config.plugins.KravenHD.FTA = ConfigSelection(default='FTAVisible', choices=[('FTAVisible', _('on')), ('none', _('off'))])
config.plugins.KravenHD.SystemInfo = ConfigSelection(default='none', choices=[('none', _('off')),
 ('systeminfo-small', _('small')),
 ('systeminfo-big', _('big')),
 ('systeminfo-bigsat', _('big + Sat'))])
config.plugins.KravenHD.SIB = ConfigSelection(default='sib4', choices=[('sib1', _('top/bottom')),
 ('sib2', _('left/right')),
 ('sib3', _('single')),
 ('sib4', _('MiniTV')),
 ('sib5', _('MiniTV2')),
 ('sib6', _('Weather')),
 ('sib7', _('Weather2'))])
config.plugins.KravenHD.IBtop = ConfigSelection(default='infobar-x2-z1_top', choices=[('infobar-x2-z1_top2', _('REC + 2 Tuner')), ('infobar-x2-z1_top', _('4 Tuner')), ('infobar-x2-z1_top3', _('8 Tuner'))])
config.plugins.KravenHD.Infobox = ConfigSelection(default='sat', choices=[('sat', _('Tuner/Satellite + SNR')),
 ('db', _('Tuner/Satellite + dB')),
 ('cpu', _('CPU + Load')),
 ('temp', _('Temperature + Fan'))])
config.plugins.KravenHD.tuner = ConfigSelection(default='4-tuner', choices=[('4-tuner', _('4 Tuner')), ('8-tuner', _('8 Tuner'))])
config.plugins.KravenHD.IBColor = ConfigSelection(default='all-screens', choices=[('all-screens', _('in all Screens')), ('only-infobar', _('only Infobar, SecondInfobar & Players'))])
config.plugins.KravenHD.About = ConfigSelection(default='about', choices=[('about', _('KravenHD'))])
config.plugins.KravenHD.Logo = ConfigSelection(default='logo', choices=[('logo', _('Logo')),
 ('minitv', _('MiniTV')),
 ('metrix-icons', _('Icons')),
 ('minitv-metrix-icons', _('MiniTV + Icons'))])
config.plugins.KravenHD.MenuIcons = ConfigSelection(default='stony272', choices=[('stony272', _('stony272')), ('stony272-metal', _('stony272-metal')), ('rennmaus-kleinerteufel', _('rennmaus-kleiner.teufel'))])
config.plugins.KravenHD.DebugNames = ConfigSelection(default='none', choices=[('none', _('off')), ('screennames-on', _('on'))])
config.plugins.KravenHD.WeatherView = ConfigSelection(default='meteo', choices=[('icon', _('Icon')), ('meteo', _('Meteo'))])
config.plugins.KravenHD.MeteoColor = ConfigSelection(default='meteo-light', choices=[('meteo-light', _('light')), ('meteo-dark', _('dark'))])
config.plugins.KravenHD.Primetimeavailable = ConfigSelection(default='primetime-on', choices=[('none', _('off')), ('primetime-on', _('on'))])
config.plugins.KravenHD.EMCSelectionColors = ConfigSelection(default='emc-colors-on', choices=[('none', _('off')), ('emc-colors-on', _('on'))])
...
config.plugins.KravenHD.SerienRecorder = ConfigSelection(default='none', choices=[('none', _('off')), ('serienrecorder', _('on'))])
config.plugins.KravenHD.MediaPortal = ConfigSelection(default='none', choices=[('none', _('off')), ('mediaportal', _('on'))])
config.plugins.KravenHD.PVRState = ConfigSelection(default='pvrstate-center-big', choices=[('pvrstate-center-big', _('center big')),
...
config.plugins.KravenHD.weather_server = ConfigSelection(default='', choices=[('', _('MSNWeather'))])
config.plugins.KravenHD.weather_search_over = ConfigSelection(default='ip', choices=[('ip', _('Auto (IP)')), ('name', _('Search String')), ('gmcode', _('GM Code'))])
...
config.plugins.KravenHD.PlayerClock = ConfigSelection(default='player-classic', choices=[('player-classic', _('standard')),
...
config.plugins.KravenHD.CategoryProfiles = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategorySystem = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryGlobalColors = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryInfobar = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryWeather = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryClock = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryECMInfos = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryViews = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryChannellist = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryEMC = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryPlayers = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryAntialiasing = ConfigSelection(default='category', choices=[('category', _(' '))])
config.plugins.KravenHD.CategoryDebug = ConfigSelection(default='category', choices=[('category', _(' '))])

config.plugins.KravenHD.msn_language = ConfigSelection(default="pl-PL", choices = [
				("de-DE", _("Deutsch")),
				("en-US", _("English")),
				("ru-RU", _("Russian")),
				("it-IT", _("Italian")),
...
class KravenHD(ConfigListScreen, Screen):
    ...
    def __init__(self, session, args = None, picPath = None):
        ...
        self['actions'] = ActionMap(['KravenHDConfigActions',
         'OkCancelActions',
         'DirectionActions',
         'ColorActions',
         'InputActions'], {'up': self.keyUp,
         'down': self.keyDown,
         'left': self.keyLeft,
         'right': self.keyRight,
         'red': self.redbutton,
...
#############
        ...
        if self.InternetAvailable:
         if config.plugins.KravenHD.InfobarStyle.value in (
         "infobar-style-nopicon", "infobar-style-x1", "infobar-style-x3", "infobar-style-z2", "infobar-style-zz1",
         "infobar-style-zz2", "infobar-style-zz3", "infobar-style-zzz1"):
          list.append(getConfigListEntry(_("Weather"), config.plugins.KravenHD.WeatherStyle,
                                         _("Choose from different options to show the weather in the infobar.")))
          ...
          if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/Netatmo/plugin.py"):
           list.append(getConfigListEntry(_("Weather"), config.plugins.KravenHD.WeatherStyle3,
                                          _("Activate or deactivate displaying the weather in the infobar.")))
         ...
         list.append(getConfigListEntry(_("Search option"), config.plugins.KravenHD.msn_searchby, _(
          "Choose from different options to enter your settings.\nPress the red button to search for the weather code.")))
         if config.plugins.KravenHD.msn_searchby.value == "location":
          list.append(getConfigListEntry(_("Location "), config.plugins.KravenHD.msn_cityname, _(
           "Enter your location.\nPress OK to use the virtual keyboard.\nPress the red button to search for the weather code.")))
         else:
          emptyLines += 1
         list.append(getConfigListEntry(_("Language"), config.plugins.KravenHD.msn_language,
                                        _("Specify the language for the weather output.")))
         list.append(getConfigListEntry(_("Refresh interval (in minutes)"), config.plugins.KravenHD.refreshInterval,
                                        _("Choose the frequency of loading weather data from the internet.")))
         list.append(getConfigListEntry(_("Weather-Style"), config.plugins.KravenHD.WeatherView,
                                        _("Choose between graphical weather symbols and Meteo symbols.")))
         if config.plugins.KravenHD.WeatherView.value == "meteo":
          list.append(getConfigListEntry(_("Meteo-Color"), config.plugins.KravenHD.MeteoColor,
                                         _("Choose between light and dark Meteo symbols.")))
         else:
          emptyLines += 1
        else:
         list.append(getConfigListEntry(_("Weather"), config.plugins.KravenHD.WeatherStyleNoInternet,
                                        _("You have no internet connection. This function is disabled.")))
        ...
        if self.actChannelselectionstyle not in ('channelselection-style-minitv', 'channelselection-style-minitv2', 'channelselection-style-minitv3', 'channelselection-style-minitv4', 'channelselection-style-minitv22', 'channelselection-style-nobile-minitv', 'channelselection-style-nobile-minitv3'):
            ...
            emptyLines += 1
        if self.actChannelselectionstyle in ('channelselection-style-zaqwa', 'channelselection-style-zaqwa2', 'channelselection-style-nobile', 'channelselection-style-nobile2', 'channelselection-style-nobile-minitv', 'channelselection-style-nobile-minitv3', 'channelselection-style-nobile-minitv33'):
        ...
        elif self.actChannelselectionstyle in ('channelselection-style-zaqwa', 'channelselection-style-zaqwa2', 'channelselection-style-nobile', 'channelselection-style-nobile2', 'channelselection-style-nobile-minitv', 'channelselection-style-nobile-minitv3', 'channelselection-style-nobile-minitv33'):
        ...
        elif option in (config.plugins.KravenHD.weather_gmcode,
         config.plugins.KravenHD.weather_cityname,
         config.plugins.KravenHD.weather_server,
         config.plugins.KravenHD.weather_search_over):
        ...
        elif option in (config.plugins.KravenHD.MenuColorTrans,
         config.plugins.KravenHD.BackgroundColorTrans,
         config.plugins.KravenHD.InfobarColorTrans,
         config.plugins.KravenHD.ChannelSelectionTrans) and option.value == '00':
            self.showText(50, _('Off'))
    ...
    def OK(self):
        ...
        if option == config.plugins.KravenHD.msn_cityname:
            from Screens.VirtualKeyBoard import VirtualKeyBoard
            text = self["config"].getCurrent()[1].value
    ...
    def save(self):
        ...
        elif config.plugins.KravenHD.BackgroundColor.value == 'self':
        ...
        if self.actChannelselectionstyle not in ('channelselection-style-zaqwa', 'channelselection-style-zaqwa2', 'channelselection-style-nobile', 'channelselection-style-nobile2', 'channelselection-style-nobile-minitv', 'channelselection-style-nobile-minitv3', 'channelselection-style-nobile-minitv33'):
            ...
            elif config.plugins.KravenHD.ChannelSelectionServiceSize.value == 'size-17':
                self.skinSearchAndReplace.append(['serviceNumberFont="Regular;25"', 'serviceNumberFont="Regular;17"'])
                self.skinSearchAndReplace.append(['serviceNameFont="Regular;25"', 'serviceNameFont="Regular;17"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionServiceSize.value == 'size-19':
                self.skinSearchAndReplace.append(['serviceNumberFont="Regular;25"', 'serviceNumberFont="Regular;19"'])
                self.skinSearchAndReplace.append(['serviceNameFont="Regular;25"', 'serviceNameFont="Regular;19"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionInfoSize.value == 'size-17':
                self.skinSearchAndReplace.append(['serviceInfoFont="Regular;23"', 'serviceInfoFont="Regular;17"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionServiceSize1.value == 'size-17':
                self.skinSearchAndReplace.append(['serviceNumberFont="Regular;20"', 'serviceNumberFont="Regular;17"'])
                self.skinSearchAndReplace.append(['serviceNameFont="Regular;20"', 'serviceNameFont="Regular;17"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionServiceSize1.value == 'size-19':
                self.skinSearchAndReplace.append(['serviceNumberFont="Regular;20"', 'serviceNumberFont="Regular;19"'])
                self.skinSearchAndReplace.append(['serviceNameFont="Regular;20"', 'serviceNameFont="Regular;19"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionInfoSize1.value == 'size-17':
                self.skinSearchAndReplace.append(['serviceInfoFont="Regular;20"', 'serviceInfoFont="Regular;17"'])
            ...
            elif config.plugins.KravenHD.ChannelSelectionInfoSize1.value == 'size-19':
                self.skinSearchAndReplace.append(['serviceInfoFont="Regular;20"', 'serviceInfoFont="Regular;19"'])
        ...
        if self.actChannelselectionstyle in ('channelselection-style-minitv', 'channelselection-style-minitv2', 'channelselection-style-minitv3', 'channelselection-style-minitv33', 'channelselection-style-minitv4', 'channelselection-style-nopicon'):
            ...
            if config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-16':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;16"'])
            elif config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-17':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;17"'])
            elif config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-18':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;18"'])
            elif config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-20':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;20"'])
            elif config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-22':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;22"'])
            elif config.plugins.KravenHD.ChannelSelectionEPGSize2.value == 'size-24':
                self.skinSearchAndReplace.append(['font="Regular;19"', 'font="Regular;24"']) 
        elif self.actChannelselectionstyle in ('channelselection-style-xpicon', 'channelselection-style-zpicon', 'channelselection-style-zzpicon', 'channelselection-style-zzzpicon'):
        ...
        if config.plugins.KravenHD.weather_server.value == '_owm':
            self.skinSearchAndReplace.append(['KravenHDWeather', 'KravenHDWeather'])
            if config.plugins.KravenHD.WeatherView.value == 'meteo':
        ...
        if self.actChannelselectionstyle in ('channelselection-style-minitv2', 'channelselection-style-minitv22'):
            config.plugins.KravenHD.PigStyle.value = 'DualTV'
        elif self.actChannelselectionstyle in ('channelselection-style-minitv33', 'channelselection-style-nobile-minitv33'):
        ...
        self.get_weather_data()
        if config.plugins.KravenHD.IBStyle.value == 'gradient':
            self.makeIbarpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value)
            if config.plugins.KravenHD.SystemInfo.value == 'systeminfo-small':
                self.makeRectpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value, 400, 185, 'info')
            elif config.plugins.KravenHD.SystemInfo.value == 'systeminfo-big':
                self.makeRectpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value, 400, 275, 'info')
            else:
                self.makeRectpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value, 400, 375, 'info')
            self.makeRectpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value, 905, 170, 'shift')
            self.makeRectpng(self.skincolorinfobarcolor, config.plugins.KravenHD.InfobarColorTrans.value, 400, 200, 'wsmall')
        self.restart()
        ...
        if answer is True:
            if config.plugins.KravenHD.defaultProfile.value == '0':
                for name in config.plugins.KravenHD.dict():
                    if name not in ('customProfile', 'DebugNames'):
        ...
        if profile and fileExists(fname):
            ...
            for line in pFile:
                try:
                    ...
                    value = line[1]
                    type = line[2].strip('\n')
                    if not (name in ('customProfile', 'DebugNames','msn_language', 'msn_searchby', 'msn_list', 'msn_cityname', 'msn_code', 'weather_owm_latlon', 'weather_accu_latlon', 'weather_realtek_latlon', 'weather_accu_id', 'weather_foundcity', 'weather_gmcode', 'weather_cityname', 'weather_language', 'weather_server') or loadDefault and name == 'defaultProfile'):
                        if type == "<type 'int'>":
            ...
            elif config.plugins.KravenHD.ChannelSelectionStyle2.value != config.plugins.KravenHD.ChannelSelectionStyle2.default:
    ...
    def saveProfile(self, msg = True):
        ...
        if profile:
            try:
                ...
                pFile = open(fname, 'w')
                for name in config.plugins.KravenHD.dict():
                    if name not in ('customProfile', 'DebugNames','msn_language', 'msn_searchby', 'msn_list', 'msn_cityname', 'msn_code', 'weather_owm_latlon', 'weather_accu_latlon', 'weather_realtek_latlon', 'weather_accu_id', 'weather_foundcity', 'weather_gmcode', 'weather_cityname', 'weather_language', 'weather_server'):
    ...
    def makeIbarpng(self, newcolor, newtrans):
        if config.plugins.KravenHD.IBStyle.value == 'gradient':
            ...
            gradientspeed = 2.0
            ibarheight = 310
            ibargradientstart = 50
            ibargradientsize = 100
            ibaroheight = 165
            ibarogradientstart = 65
            ibarogradientsize = 100
            ibaro2height = 125
            ibaro2gradientstart = 25
            ibaro2gradientsize = 100
            ibaro3height = 145
            ibaro3gradientstart = 45
            ibaro3gradientsize = 100
            newcolor = newcolor[-6:]
            r = int(newcolor[0:2], 16)
            g = int(newcolor[2:4], 16)
            b = int(newcolor[4:6], 16)
            trans = (255 - int(newtrans, 16)) / 255.0
            img = Image.new('RGBA', (width, ibarheight), (r,
             g,
             b,
             0))
            ...
            img = Image.new('RGBA', (width, ibaroheight), (r,
             g,
             b,
             0))
            ...
            img = Image.new('RGBA', (width, ibaro2height), (r,
             g,
             b,
             0))
            ...
            img = Image.new('RGBA', (width, ibaro3height), (r,
             g,
             b,
             0))
    ...
    def makeRectpng(self, newcolor, newtrans, width, height, pngname):
        if config.plugins.KravenHD.IBStyle.value == 'gradient':
            ...
            b = int(newcolor[4:6], 16)
            trans = (255 - int(newtrans, 16)) / 255.0
            img = Image.new('RGBA', (width, height), (r,
             g,
             b,
             int(255 * trans)))
            gradient = Image.new('RGBA', (1, gradientsize), (r,
             g,
             b,
             0))
            for pos in range(0, gradientsize):
                gradient.putpixel((0, pos), (r,
                 g,
                 b,
                 int(self.dexpGradient(gradientsize, gradientspeed, pos) * trans)))

            hgradient = gradient.resize((width - 2 * gradientsize, gradientsize))
            img.paste(hgradient, (gradientsize,
             0,
             width - gradientsize,
             gradientsize))
            ...
            img.paste(vgradient, (0,
             gradientsize,
             gradientsize,
             height - gradientsize))
            vgradient = vgradient.transpose(Image.ROTATE_180)
            img.paste(vgradient, (width - gradientsize,
             gradientsize,
             width,
             height - gradientsize))
            corner = Image.new('RGBA', (gradientsize, gradientsize), (r,
             g,
             b,
             0))
            for xpos in range(0, gradientsize):
                for ypos in range(0, gradientsize):
                    ...
                    corner.putpixel((xpos, ypos), (r,
                     g,
                     b,
                     int(self.dexpGradient(gradientsize, gradientspeed, gradientsize - dist - 1) * trans)))

            corner = corner.filter(ImageFilter.BLUR)
            img.paste(corner, (width - gradientsize,
             height - gradientsize,
             width,
             height))
    ...
    def get_latlon_by_ip(self):
        try:
            res = requests.request('get', 'http://ip-api.com/json/?lang=de&fields=status,city,lat,lon')
            data = res.json()
    ...
    def checkCode(self):
     if self.InternetAvailable:
      ...
      if option.value == "auto-ip":
       ...
       try:
        res_gc = requests.get(
         'http://weather.service.msn.com/find.aspx?src=windows&outputview=search&weasearchstr=' + str(
          cityip) + '&culture=' + str(config.plugins.KravenHD.msn_language.value), timeout=1)
      ...
      if option.value == "location" or option == config.plugins.KravenHD.msn_cityname:
       ...
       try:
        res_gc = requests.get(
         'http://weather.service.msn.com/find.aspx?src=windows&outputview=search&weasearchstr=' + str(
          config.plugins.KravenHD.msn_cityname.value) + '&culture=' + str(config.plugins.KravenHD.msn_language.value),
         timeout=1)
        data_gc = fromstring(res_gc.text)
